        ...
        <tr v-for="(item,index) in files" :key='index'>
          ...
          <td>
            <Poptip trigger="hover">
              <a v-bind:href="'javascript:GLOBAL.newTab(\'' + item.fileAddress + '\')'">{{item.fileOriginalName}}</a>
          ...
          <td>
            <i-button type="text" icon="ios-cloud-upload-outline" size="small" @click="uploadBtn(item)">上传</i-button>
