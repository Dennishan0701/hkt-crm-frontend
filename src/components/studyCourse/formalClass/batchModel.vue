...
//        this.iframe = `<!--<iframe id="childFree" src="../../../../static/timetable.html?uuid=${uuid}" frameborder="0" width=100% height=600px frameborder=auto></iframe>-->`;
        this.iframe = `<iframe id="childFree" src="../../../../static/batchSchedule.html?leadsUuid=${leadsUuid}&teacherUuid=${teacherUuid}&courseOrderUuid=${courseOrderUuid}" frameborder="0" width=100% height=600px frameborder=auto></iframe>`;
