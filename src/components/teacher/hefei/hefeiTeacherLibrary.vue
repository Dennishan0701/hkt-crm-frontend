<template>
<div>
  <o-breadcrumb second="师资管理" third="合肥-师资库"></o-breadcrumb>
  <div class="grid-widget">
    <Row>
      <i-col span="24" class="right">
        ...
        <i-input :size="$store.state.searchModuleSize" v-model="Search.phone" @on-keyup.enter="searchForm(1)" placeholder="手机号"
                 style="width:150px;margin-right: 2px;"></i-input>
        ...
        <!--</i-select>-->
        <i-select :size="$store.state.searchModuleSize" v-model="Search.schoolLocation" filterable clearable placeholder="院校"
                  style="width:200px">
        ...
        <i-select :size="$store.state.searchModuleSize" v-model="Search.province" @on-change="changeSelectedCity" filterable clearable
                  placeholder="高考所在省" style="width:150px">
          <i-option v-for="(item,index) in provinceList" :key='index' :value="item.areaCode">{{ item.areaName }}</i-option>
        </i-select>
        <i-select :size="$store.state.searchModuleSize" v-model="Search.city" @on-change="changeSelectedArea" filterable clearable
                  placeholder="高考所在市" style="width:150px">
          <i-option v-for="(item,index) in cityArrays" :key='index' :value="item.areaCode">{{ item.areaName }}</i-option>
        </i-select>
        <i-select :size="$store.state.searchModuleSize" v-model="Search.district" filterable clearable placeholder="高考所在区"
                  style="width:150px">
      ...
      <i-col span="24" class="right">
        <Date-picker :size="$store.state.searchModuleSize" type="daterange" placement="bottom-end" @on-change="changePushDate" placeholder="入库时间"
  ...
  <i-table size="small" :height="theight" highlight-row stripe :columns="columns" :data="data"
           @on-current-change="changeCurrentRow"></i-table>
  <div class="gridPage">
  ...
  <Modal
    ...
    <i-form ref="formValidateCourseStatus" :model="validateStatus" :rules="ruleValidateStatus" :label-width="80">
      ...
      <Form-item label="排课备注" prop="remark">
        <i-input type="textarea" v-model="validateStatus.remark" :rows="4" :maxlength="500"
