  ...
  <div class="grid-widget right">
    <Row>
      <i-col span="24">
        ...
        <i-select :size="$store.state.searchModuleSize" v-model="Search.isUpdate" placeholder="是否更新空闲时间" style="width:172px">
...
//            },
    ...
    methods: {
      ...
      loadDataGrid(search, orderBy = '', sortBy = '') {
        let param = `?teacherParams=${search.teacherParams}&isUpdate=${search.isUpdate}&natureOfWork=${search.natureOfWork}&updateTimeStart=${search.updateTimeStart}&updateTimeEnd=${search.updateTimeEnd}`;
