<template>
  <div class="mc">
    <o-breadcrumb second="数据报表" third="结课学员"></o-breadcrumb>
    <div class="grid-widget">
      <Row>
        <i-col span=24 class="right">
          ...
          <i-button :size="$store.state.searchModuleSize" type="primary" size="small" icon="search" @click="search(1)">搜索</i-button>
        </i-col>
        <i-col span=24 class="right">
