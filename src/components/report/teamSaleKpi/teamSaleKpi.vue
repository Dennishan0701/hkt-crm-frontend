  ...
  <div class="total-sale-kpi">
    <div class="searchForm">
      ...
      <Row>
        <i-col span=24 class="right">
          ...
          <!--<i-button type="primary" size="small" icon="ios-download-outline" @click="exportExcel">导出</i-button>-->
        </i-col>
      </Row>
      </div>
    </div>
    <div class="content" @scroll=handleScroll>
      <table class="report-form">
        ...
        <tbody>
          <tr>
            <td colspan="46" style="padding: 0;border: 0;">
              <div class="td-data-list">
                <table>
                  <tbody>
...
//      },
      ...
      loadDataGrid(startTime, endTime,type) {
        ...
        const _this = this;
        common.ajax({
          url: REPORT().Sale.getManagerTeamSaleKpi + param,
          method: 'get',
