<template>
  <div class="mc">
    <o-breadcrumb second="数据报表" third="招生代理-秀妈"></o-breadcrumb>
...
//              return `<i-button type="warning" size="small" icon="calendar" title="获取历史备注信息" @click="getStudentHistoryInfo('${row.leadsPhone}')"></i-button>`
            }
          },
        ]
      }
