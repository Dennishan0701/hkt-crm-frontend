<template>
  <div>
    <o-breadcrumb second="教研" third="课件管理"></o-breadcrumb>
    <div class="grid-widget">
      <Row>
        ...
        <i-col span="20" class="right">
          ...
          <i-select :size="$store.state.searchModuleSize" v-model="Search.coursewareType" clearable placeholder="课件类型" style="width:180px;text-align: left">
            <i-option value="SYSTEM">系统课件</i-option>
            <i-option value="TEACHER">个人课件</i-option>
          </i-select>
    ...
    methods: {
      ...
      searchForm(val) {
        ...
        this.loadDataGrid({
          ...
          coursewareType: this.Search.coursewareType,
        });
      },
