<template>
  <div>
    <o-breadcrumb second="分配管理" third="意向试听名单"></o-breadcrumb>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            title: '分配与首次拨打间隔',
            align: 'center',
            key: 'differenceOfMinutes',
            minWidth: 130,
            render(h, params) {
              if(params.row.differenceOfMinutes){
                return h('span',params.row.differenceOfMinutes+'分钟');
              }else{
                return h('span','');
              }
          ...
          },
          {
            ...
            minWidth: 150,
            render(h, params) {
              return h('span',formateDate(params.row.firstCallTime,'yyyy-MM-dd hh:mm:ss'));
            }
          },
          {
            title: '分配时间',
