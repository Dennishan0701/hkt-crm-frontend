...
<div>
  <div class="waitFollowedManager">
    <o-breadcrumb second="销售与客服" third="本月可维护学生"></o-breadcrumb>
...
<script type="text/ecmascript-6">
  ...
  export default{
    data() {
      return {
        data: [],
        tableColumnsChecked:['keyPoint','studentPhone','grade','payTime',
          'remarkContent','responsibleTime','handOutDes','action'],
        total: 0,
        pageIndex: 1,
...
//            return hideCharAtNumber(params.row.studentPhone) + ` <Icon type="ios-eye" @click="getFullPhone('${row.studentPhone}')" class="eye" title="显示全部"></Icon>
