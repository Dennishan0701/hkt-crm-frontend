...
<div>
  <div class="waitFollowedManager">
    <o-breadcrumb second="销售与客服" third="CR我的退费学生"></o-breadcrumb>
    ...
    <checkbox-group v-model="tableColumnsChecked" @on-change="changeTableColumns">
      ...
      <checkbox label="studentName">学生姓名</checkbox>
...
<script type="text/ecmascript-6">
  ...
  export default{
    data() {
      return {
        data: [],
        tableColumnsChecked:['keyPoint','studentName','studentPhone','grade','payTime',
...
//              <i-button type="success" size="small"  icon="plane" title="绿色通道" @click="greenChannel('${row.leadsUuid}')"></i-button>`;
        ...
        let datas = [columns.selection,columns.index];
