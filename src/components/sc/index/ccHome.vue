<template>
  <div>
    <o-breadcrumb second="CC首页"></o-breadcrumb>
    <div class="sc-cc-index">
      <Row>
        ...
        <i-col span="24">
          ...
          <table class="onlyhi-table" style="width: 100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <th>统计</th>
              <td>{{Sel.lists}}</td>
              <td>{{Sel.signLeadsNumber||0}}</td>
              <td>{{Sel.arrangeCourseNumber||0}}</td>
              <td>{{Sel.signMoney||0}}</td>
              <td>{{Sel.signOrderNumber||0}}</td>
            </tr>
            </tbody>
          </table>
        </i-col>
      ...
      common.ajax({
        ...
        success: function(res) {
          if(res.data){
            ...
            // console.log(that.monthPersonalTopTenSale);
